...
% if interested in latex dev
  % $ lualatex-dev -shell-escape -8bit main
% # If any change in the bibliography
% $ biber main
% # If any change with the abbreviation or acronym
% $ makeglossaries main
...
\input{chapters/0figs_tables_all.tex}
%----------------------------------------------------------------------------------------
...
\input{chapters/fuzzyTesting.tex}
\input{chapters/fuzzing_tools_fuzzers.tex}
